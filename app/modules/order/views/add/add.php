              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <select name="category_id" class="form-control square ajaxChangeCategory" id='catt' data-url="<?=cn($controller_name."/get_services/")?>">
                  ...
                  <div class="form-group" id="result_onChange">
                    ...
                    <select name="service_id" class="form-control square ajaxChangeService" id="seriv29" data-url="<?=cn($controller_name."/get_service/")?>">
                  ...
                  $("#catt").val("29").change();
                   ...
                   $('#seriv29').load('<?=cn($controller_name."/get_services/29")?>');
                  ...
                  <div class="form-group order-default-link">
                    ...
                    <input class="form-control square" type="text" name="link" placeholder="Character name" id="">
                  </div>
            ...
            <form class="form actionForm" action="<?=cn($controller_name."/ajax_mass_order")?>" data-redirect="<?=cn($controller_name."/log")?>" method="POST">
              <div class="x_content row">
                <div class="col-md-6 col-sm-12 col-xs-12">
                  ...
                  <div class="form-group">
                    <label class="custom-control custom-checkbox">
                      <input type="checkbox" class="custom-control-input" id="checkthis" name="agree">
                      <span class="custom-control-label text-uppercase"><?=lang("yes_i_have_confirmed_the_order")?></span>
                    </label>
                  </div>
